  ...
  return (
    <div className='all'>
      <div className="thought">
        <h1 className='thoughthead'>Hey, let's prioritize our health <br/>and happiness and make the most of our time!</h1>
      ...
      <div className='imagecont'>
        <div className='containerdetails'>
          <h1><span className='salubiname'>Healthify</span> can be your companion in maintaining a healthy and happy lifestyle.</h1>
